    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-lg-4 p-4">
          ...
          <FormGroup>
            <Label for="exampleNumber">Give me a true Number:</Label>
            <Input
              id="exampleNumber"
              name="number"
              placeholder="number"
        ...
        <div className="col-lg-8 d-none  d-lg-block">
          <Lottie options={defaultOptions1} height={800} width={600} />
        </div>
        <div className="col-4 d-none  d-lg-block">
          <Lottie options={defaultOptions2} height={800} width={600} />
        </div>
        <div className="col-lg-8 align-self-center">
          <h1 className="display-1 text-center">How to Find me?</h1>
          <h4 className="text-center ">
            <a href="https://instagram.com/rezaser">
              <svg
            ...
            <a href="https://wa.me/+989190774072" className="mx-5">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="64"
                height="64"
